...
const Sidebar = () => {
    ...
    return (
        <div className={`absolute w-screen h-screen overflow-hidden z-30 top-0 m-0 flex justify-end ${toggle ? 'visible' : 'invisible'} duration-500 ease-in-out`}>
            <div className="relative w-1/4 h-ful"  onClick={handleClick}></div>
            <div 
                className={`relative w-3/4 h-full bg-slate-500 p-6 flex flex-col justify-between transition-transform duration-300 ease-in-out md:hidden 
